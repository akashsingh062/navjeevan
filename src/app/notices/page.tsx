...
export const metadata = {
  ...
  description: "Official Nav Jeevan Public School notice board. Access exam datesheets, holiday announcements, CBSE circulars, and admission updates in Captanganj.",
};
