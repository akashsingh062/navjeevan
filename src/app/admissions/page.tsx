...
import { Download, FileCheck, Calendar, Clock, AlertTriangle, ArrowDown } from "lucide-react";

export const metadata = {
  title: "Admissions 2026-27 | Nav Jeevan Public School Captanganj",
  description: "Information about admission process, age eligibility, required documents, and fee structures at Nav Jeevan Public School. Download forms online.",
};
...
export default function Admissions() {
  const steps = [
    {
      ...
      desc: "Collect the official admission form from the school counter in Khabharabhar, Captanganj during office hours (8:00 AM to 1:00 PM), or download it below."
    },
    {
      num: "02",
  ...
  const eligibility = [
    { class: "Nursery / LKG", age: "3 to 4 Years", criteria: "Should be toilet-trained and responsive to verbal instructions." },
    { class: "UKG / Class I", age: "4 to 5+ Years", criteria: "Should recognize basic alphabet sounds and numbers." },
    { class: "Class II to V", age: "6 to 9 Years", criteria: "Basic Hindi and English reading skills. Simple arithmetic." },
    { class: "Class VI to VIII", age: "10 to 12 Years", criteria: "Passing certificate from previous school. Written check score." },
    { class: "Class IX to XII", age: "13 to 15+ Years", criteria: "Class VIII/X pass sheet. Written evaluation score in core subjects." }
  ];
  ...
  const fees = [
    { range: "Nursery to UKG", admission: "₹1,000 (Once)", tuition: "₹650 / Month", exam: "₹300 / Term" },
    { range: "Class I to V", admission: "₹1,500 (Once)", tuition: "₹800 / Month", exam: "₹400 / Term" },
    { range: "Class VI to VIII", admission: "₹1,800 (Once)", tuition: "₹1,000 / Month", exam: "₹450 / Term" },
    { range: "Class IX to X", admission: "₹2,500 (Once)", tuition: "₹1,300 / Month", exam: "₹500 / Term" },
    { range: "Class XI to XII", admission: "₹3,000 (Once)", tuition: "₹1,600 / Month", exam: "₹600 / Term" }
  ];
  ...
  return (
    <div className="py-12 bg-white flex-1">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start border-t border-gray-100 pt-16 mb-16">
                ...
                <tbody className="divide-y divide-gray-100 text-neutral-body font-normal">
                  {eligibility.map((el, idx) => (
                    <tr key={idx} className="hover:bg-neutral-light/35 transition-colors">
                      <td className="p-4 font-extrabold text-neutral-dark whitespace-nowrap">{el.class}</td>
                      <td className="p-4 font-semibold text-primary whitespace-nowrap">{el.age}</td>
          ...
          <div className="lg:col-span-5 bg-neutral-light border border-gray-200 rounded-3xl p-6 md:p-8 flex flex-col gap-5">
            ...
            <p className="text-xs text-neutral-body leading-relaxed font-normal -mt-2">
              Please submit self-attested photocopies of these documents along with the physical form. Keep originals handy for verification.
            </p>
          ...
          <div className="overflow-x-auto border border-gray-200 rounded-2xl shadow-sm bg-white mt-8">
            <table className="w-full text-left border-collapse text-xs md:text-sm">
              ...
              <tbody className="divide-y divide-gray-100 text-neutral-body font-normal">
                {fees.map((fee, idx) => (
                  <tr key={idx} className="hover:bg-neutral-light/35 transition-colors">
                    <td className="p-4 font-extrabold text-neutral-dark whitespace-nowrap">{fee.range}</td>
                    <td className="p-4 font-semibold text-neutral-body whitespace-nowrap">{fee.admission}</td>
                    <td className="p-4 font-extrabold text-accent whitespace-nowrap">{fee.tuition}</td>
                    <td className="p-4 font-semibold text-neutral-body whitespace-nowrap">{fee.exam}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="mt-5 p-4.5 bg-amber-50 border border-amber-200 rounded-xl flex gap-3 items-start text-xs text-amber-800 leading-relaxed font-semibold">
            ...
            <div>
              ...
              <ul className="list-disc list-inside mt-1 font-medium text-[11px] flex flex-col gap-1">
                <li>Monthly tuition fees must be deposited at the counter by the 10th of every month.</li>
                <li>Special fee concessions are available for siblings (brother/sister studying together).</li>
                <li>Subsidies are offered to parents from weaker economic categories upon verification of state category certificates.</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section id="download" className="py-12 bg-neutral-light border border-gray-200 rounded-3xl p-6 md:p-8 flex flex-col lg:flex-row items-center justify-between gap-8 mb-16">
          <div className="flex flex-col gap-2 max-w-xl text-left">
            <span className="text-xs font-black text-primary uppercase tracking-wider">Printable Application</span>
            ...
            <p className="text-xs md:text-sm text-neutral-body leading-relaxed font-normal">
              Prefer filling out a paper form? Download our bilingual, easy-to-print PDF form. Print it out, fill in the details, and bring it to our Captanganj office counter with documents.
            </p>
          </div>
        ...
        <section id="inquiry-form" className="py-16 border-t border-gray-100">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 flex flex-col gap-6 text-left">
              <span className="text-xs font-black text-primary uppercase tracking-widest">Enrollment Help</span>
              <SectionHeading
              ...
              <div className="flex flex-col gap-4 text-xs text-neutral-body">
                <div className="flex gap-3 items-center">
                  ...
                  <span className="font-semibold">Bilingual help via phone or WhatsApp.</span>
                </div>
                <div className="flex gap-3 items-center">
                  <div className="w-8 h-8 rounded-lg bg-emerald-100 text-emerald-700 flex items-center justify-center font-bold">
                    2
                  </div>
                  <span className="font-semibold">Sub-second form submit with honeypot security.</span>
                </div>
                <div className="flex gap-3 items-center">
                  <div className="w-8 h-8 rounded-lg bg-amber-100 text-amber-700 flex items-center justify-center font-bold">
                    3
                  </div>
                  <span className="font-semibold">No paperwork charges for basic queries.</span>
                </div>
              </div>
            </div>
