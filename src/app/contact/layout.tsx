...
export const metadata: Metadata = {
  ...
  description:
    "Contact Nav Jeevan Public School (NJPS) Khabharabhar, Kaptanganj, Kushinagar. Phone: +91 99210 08807. Address: Khabharabhar, Kaptanganj, Kushinagar, UP 274301. Enquiry form available.",
