...
export const metadata: Metadata = {
  ...
  description:
    "Contact Nav Jeevan Public School (NJPS) Khabharabhar, Kaptanganj, Kushinagar. Phone: +91 7880952150. Address: Khabharabhar, Kaptanganj, Kushinagar, UP 274301. Enquiry form available.",
