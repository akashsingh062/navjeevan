...
export const metadata = {
  ...
  description:
    "Learn about the rich history, vision, and mission of Nav Jeevan Public School. Affiliated with CBSE, providing high-quality bilingual education in Kaptanganj.",
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start border-b border-gray-100 pb-16">
          <div className="lg:col-span-7 flex flex-col gap-5 text-sm md:text-base text-neutral-body font-normal leading-relaxed">
            ...
            <p>
              Nav Jeevan Public School was established in 2008 with a simple yet
              ambitious goal: to bring premium, modern, and value-based
              education to children in the rural pockets of Kaptanganj,
              Kushinagar, Uttar Pradesh. Recognizing that language fluency and
              computer literacy are key barriers for rural progress, we
              structured our curricula around bilingual teaching guidelines.
            </p>
            <p>
              Over the last decade and a half, our institution has grown from a
              local primary class center into a reputable CBSE-pattern
              co-educational school. Today, we cater to hundreds of boys and
              girls from Khabharabhar and nearby villages, ensuring they secure
              high scores in higher education exams and clear entrance
            ...
            <div className="mt-4 p-5 bg-neutral-light border border-gray-200 rounded-2xl flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-xs text-neutral-body mt-1 leading-relaxed">
                  Nav Jeevan is recognized under the educational standards of
                  Uttar Pradesh. The school operates on strict CBSE pattern
                  methodologies, preparing children for modern competitive
                  challenges. Both English and Hindi instruction formats are
                  actively sustained.
                </p>
              </div>
            </div>
        ...
        <section className="py-16 bg-neutral-light border border-gray-200 rounded-3xl p-6 md:p-10 my-12">
          <div className="max-w-3xl mx-auto flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4 text-sm md:text-base text-neutral-body font-normal leading-relaxed">
              ...
              <p>
                Welcome to Nav Jeevan Public School! It is a distinct privilege
                to lead an educational community where our staff members,
                student body, and parents collaborate in building supportive,
                character-defining, and capable lives.
              </p>
              <p>
                We recognize that rural areas in Kushinagar are brimming with
                pure talent, child analytical capability, and creative energies.
                However, students often face hurdles in competitive exam fields
                due to a lack of core English language confidence and digital
                computing literacy.
              </p>
              <p>
                At Nav Jeevan, we bridges this divide. Our bilingual classrooms
                are geared toward removing language fear. Our computer
                practicals ensure kids from class III can handle digital systems
                comfortably. Our moral drills establish strong character,
                respect for elders, and national pride.
              </p>
              <p>
                We welcome you to partner with us in this beautiful journey. Let
                us hold hands to secure the absolute best developmental path for
                our children.
              </p>
            </div>
            ...
            <div className="mt-6 pt-6 border-t border-gray-300 flex flex-col">
              ...
              <span className="text-xs text-gray-500 font-medium">
                M.Sc., B.Ed., M.Ed. | 22+ Years Educational Service
              </span>
            </div>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
            <div className="p-5 bg-white border border-gray-200 rounded-2xl flex gap-3.5 items-start">
              ...
              <div>
                ...
                <p className="text-xs text-neutral-body mt-1 leading-relaxed">
                  Consecutive academic batches have achieved a 100% pass record
                  in Class X standard curriculum tests, with top students
                  scoring over 90% in Science and Math.
                </p>
              </div>
            </div>
            ...
            <div className="p-5 bg-white border border-gray-200 rounded-2xl flex gap-3.5 items-start">
              ...
              <div>
                <h4 className="text-sm font-extrabold text-neutral-dark">
                  District Sports Trophies
                </h4>
                <p className="text-xs text-neutral-body mt-1 leading-relaxed">
                  Our student sports contingents have bagged Gold and Silver
                  placements in block-level Kabaddi, Kho-Kho, and 400m sprint
                  events in Kushinagar tournaments.
                </p>
              </div>
            </div>
            ...
            <div className="p-5 bg-white border border-gray-200 rounded-2xl flex gap-3.5 items-start">
              ...
              <div>
                <h4 className="text-sm font-extrabold text-neutral-dark">
                  Regional Scholarship Qualifiers
                </h4>
                <p className="text-xs text-neutral-body mt-1 leading-relaxed">
                  Multiple children from weaker economic backgrounds have
                  successfully cracked government merit scholarship programs
                  under our teacher coaching models.
                </p>
              </div>
            </div>
          </div>
  ...
  return (
    ...
    >
      <path
        ...
        d="M4.263 10.185a.75.75 0 0 0 0 1.206l6.705 4.917a.75.75 0 0 0 .89 0l6.705-4.917a.75.75 0 0 0 0-1.206l-6.705-4.917a.75.75 0 0 0-.89 0l-6.705 4.917Z"
      />
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M12 18.75v-6.75m0 6.75H8.25m3.75 0h3.75m-7.5 0v-2.25c0-.621.504-1.125 1.125-1.125h5.25c.621 0 1.125.504 1.125 1.125v2.25"
      />
    </svg>
  );
}
