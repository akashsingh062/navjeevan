        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-sm text-gray-400 leading-relaxed font-normal">
              A co-educational English & Hindi medium school affiliated with CBSE standards, dedicated to raising the level of education and empowerment in rural regions.
            </p>
          ...
          <div>
            ...
            <ul className="grid grid-cols-2 gap-x-4 gap-y-2.5 text-sm" aria-label="Footer Navigation">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <Link 
                    href={link.href} 
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3.5 text-sm text-gray-400">
              <li className="flex gap-3">
                ...
                <div>
                  <span className="block font-bold text-gray-300">Summer Timings:</span>
                  <span className="block text-xs mt-0.5">07:30 AM - 12:30 PM (Mon - Sat)</span>
                </div>
              </li>
              <li className="flex gap-3">
                <Clock className="w-5 h-5 text-accent shrink-0 mt-0.5" />
                <div>
                  <span className="block font-bold text-gray-300">Winter Timings:</span>
                  <span className="block text-xs mt-0.5">08:30 AM - 01:30 PM (Mon - Sat)</span>
                </div>
              </li>
              <li className="flex gap-3">
